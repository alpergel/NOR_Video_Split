...
def get_length(filename):
    result = subprocess.run(['C:\\Users\\aalis\\Documents\\Code\\ConboyLab\\ffmpeg\\ffmpeg-2023-10-12-git-a7663c9604-essentials_build\\bin\\ffprobe.exe', "-v", "error", "-show_entries",
                             "format=duration", "-of",
